...
示意图如下
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/da99540456c743e4a3eb1b235b9435fb~tplv-k3u1fbpfcp-zoom-1.image)
...
两者的区别如下
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/00a29227f65d46e0b435f2ef129f548a~tplv-k3u1fbpfcp-zoom-1.image)
...
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b12b40231379434384b781521b7592b8~tplv-k3u1fbpfcp-zoom-1.image)
...
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1a1cc6c40ec3495e89003643ea3899b5~tplv-k3u1fbpfcp-zoom-1.image)
...
![640](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1bc206dd93e247338a178a11bf359324~tplv-k3u1fbpfcp-zoom-1.image)
...
![image-20201015123445858](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3ec98e33fb96496084753670fd2a2d58~tplv-k3u1fbpfcp-zoom-1.image)
...
![公平锁与非公平锁](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ca6c63aae383481bb854ad06cbab82eb~tplv-k3u1fbpfcp-zoom-1.image)
...
几个类的关系如下：
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e5747974a6ea4f9a8f3465cad4e9f1d1~tplv-k3u1fbpfcp-zoom-1.image)

我们先来剖析下非公平锁（NonfairSync）的实现方式，来看上述示例代码的第二步：加锁，由于默认的是非公平锁的加锁，所以我们来分析下非公平锁是如何加锁的

![image-20201011104444923](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/18296e691e244db18ffba290599b243b~tplv-k3u1fbpfcp-zoom-1.image)
...
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1f8bb07ee16c45fbb4b296665c336a7a~tplv-k3u1fbpfcp-zoom-1.image)

假设现在 T1 获取锁成功，则两种情况分别为
1、 T1 首次获取锁成功
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4026bcc2d4b84967b48f65dd227bb40a~tplv-k3u1fbpfcp-zoom-1.image)

2、 T1 再次获取锁成功，state 再加 1，表示锁被重入了两次，当前如果 T1一直申请占用锁成功，state 会一直累加

![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9b6e2b2ff9f545ed95e6456a7a503b75~tplv-k3u1fbpfcp-zoom-1.image)
...
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4f4586080870403bbd86db8414fd9e33~tplv-k3u1fbpfcp-zoom-1.image)


2、此时 T2 或 T3 再去竞争 state 失败，入队，如下图:

![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4197ba6f6f044fe48235ee98f3caa9e7~tplv-k3u1fbpfcp-zoom-1.image)
...
![image-20201013235029901](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/87c59cdb5ed748be9d9ff2d525ab1b83~tplv-k3u1fbpfcp-zoom-1.image)
...
![image-20201013234933316](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5cf52bcd946542bb9a01fe09add2c867~tplv-k3u1fbpfcp-zoom-1.image)
...
![image-20201013235125477](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7d3f711e07ed475ea4a5ea72a5065deb~tplv-k3u1fbpfcp-zoom-1.image)
...
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/24cadcfaacca422994a2ace53e2d6936~tplv-k3u1fbpfcp-zoom-1.image)
...
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/880f9219c6ba4267939cdc5b19466715~tplv-k3u1fbpfcp-zoom-1.image)

2、如果当前结点既非头结点的后继结点，也非尾结点，即步骤 1 所示，则最终结果如下
![image-20201014233652908](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2d268c4ed10e418cb842ad0934baa661~tplv-k3u1fbpfcp-zoom-1.image)
...
![image-20201014234213302](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3aa792c507f14372a3b58957d356578b~tplv-k3u1fbpfcp-zoom-1.image)
可以看到此时中间的两个 CANCEL 节点不可达了，会被 GC

3、如果当前结点为 tail 结点，则结果如下，这种情况下当前结点不可达，会被 GC
![image-20201014234914397](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/955336d165be40b2ba0430f0168c500d~tplv-k3u1fbpfcp-zoom-1.image)


4、如果当前结点为 head 的后继结点时，如下

![image-20201014235420960](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/757b29e42d654bf8b628ddd29853232d~tplv-k3u1fbpfcp-zoom-1.image)


结果中的 CANCEL 结点同样会在 tail 结点自旋调用 shouldParkAfterFailedAcquire 后不可达，如下

![image-20201015000608054](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d8b46e26d8784a3c90c4d24717a82288~tplv-k3u1fbpfcp-zoom-1.image)
...
![image-20201015075134541](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d2ee362a8808495ca220b3a7356778b8~tplv-k3u1fbpfcp-zoom-1.image)

线程自旋时时是先执行 node.pre = pred, 然后再执行 pred.next = node，如果 unparkSuccessor 刚好在这两者之间执行，此时是找不到  head 的后继节点的，如下

![image-20201015075608021](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/daf4650791e94ed59a86450a43f63344~tplv-k3u1fbpfcp-zoom-1.image)
...
![](//p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0c8c94def9a74be08a5fbe05ef84310a~tplv-k3u1fbpfcp-zoom-1.image)
